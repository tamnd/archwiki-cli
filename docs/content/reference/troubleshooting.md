...
Most of these come down to network reality or how archwiki serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

archwiki rate-limits like any public site. archwiki already paces
...
Where a surface is gated, archwiki reads a cookie or token you supply
...
`archwiki`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what archwiki actually did
